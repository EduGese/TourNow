 ...
 */
final class Version20230609134712 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE activity CHANGE scores scores INT DEFAULT 0, CHANGE average_score average_score NUMERIC(2, 1) DEFAULT \'0\'');
